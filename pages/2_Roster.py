...
with tab2:
    ...
    st.markdown(
        ...
        <div style='text-align:left; color:{LIGHT_GREY}; font-size:15px; margin-top:10px;'>
            ...
            <p>
                <span style='color:{ESPN_BLUE};'>Points (Avg)</span> is calculated exclusively on the weeks in which a player was on your roster and reflects their
            ...
            <p>
                ...
                <span style='color:{ESPN_BLUE};'>Difference</span>, <span style='color:{ESPN_BLUE};'>Games</span>, and  
                <span style='color:{ESPN_BLUE};'>Starts</span> while on your roster.
            </p>
        </div>
        """,
        unsafe_allow_html=True
